...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        ...
        options=[
            {'label': metric, 'value': metric} for metric in ['Yes','No']],
...
def update_scatter_plot(selected_big_scape_class, selected_distance_metric, selected_average_distance, selected_color_scale, selected_hybrids):
    ...
    try: # Because they can select Hybrid class without having Hybrids separated selected
